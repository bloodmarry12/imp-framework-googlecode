 ...
 */
public abstract class ConstantValueTypeNameHandler implements
		TypeHandlerCallback
{
	 ...
	 * @param modelID
	 */
	public ConstantValueTypeNameHandler(String modelID){
	...
	public void setParameter(ParameterSetter arg0, Object arg1)
			throws SQLException {
		arg0.setString(((ConstantValue) arg1).getName());
	}
