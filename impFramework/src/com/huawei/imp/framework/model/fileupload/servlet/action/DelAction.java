 ...
 *
 */
public class DelAction implements ActionSupport {
	...
	public String doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		String filePath = request.getParameter("fileFullName");
		FileUploadServiceFactory.getFileUploadService().delTmpFile(filePath);
